  ...
  head: () => ({
    meta: [
      { title: "crestQ | Online Maths Tutoring for Class 1 to 12 | $9/hour" },
      {
        name: "description",
        content:
          "crestQ offers affordable online 1-on-1 maths tutoring for Class 1 to 12 students in USA, Canada and global locations at just $9/hour. Book a free trial class today.",
      },
