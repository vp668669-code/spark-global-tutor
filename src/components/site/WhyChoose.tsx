...
const features = [
  { icon: GraduationCap, title: "Expert Math & Science Tutors", desc: "Hand-picked, trained and experienced in teaching global students." },
  { icon: DollarSign, title: "Affordable Global Pricing", desc: "Premium 1-on-1 classes at just $10/hour — unbeatable value." },
